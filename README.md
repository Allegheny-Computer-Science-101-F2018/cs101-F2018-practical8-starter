...
# cs101-F2018-practical8-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Practical 8 in Computer Science 101. Since
...
tool](https://github.com/GatorEducator/gatorgrader). For instance, GatorGrader will
...
- practicaleight/DoublyLinkedList.java:
  - Contains at least twenty-nine multi-line comments in the JavaDoc standard
  - Contains at least two `println` statements to produce program output
  - Contains exactly one `public static void main` method to produce textual
    output
  - Contains exactly zero of the comment fragment that marks incomplete tasks
  - Runs correctly without crashing or producing an error while producing four
    lines of output
...
you can go to the [Computer Science 101 Practical 8
Starter](https://github.com/Allegheny-Computer-Science-101-F2018/cs101-F2018-practical8-starter)
